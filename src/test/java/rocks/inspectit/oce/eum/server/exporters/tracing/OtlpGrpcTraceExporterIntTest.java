...
public class OtlpGrpcTraceExporterIntTest extends ExporterIntTestBaseWithOtelCollector {
    ...
    static class EnvInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext applicationContext) {
            TestPropertyValues.of("inspectit-eum-server.exporters.tracing.otlp.enabled=" + ExporterEnabledState.ENABLED,
                            "inspectit-eum-server.exporters.tracing.otlp.endpoint=" + getEndpoint(COLLECTOR_OTLP_GRPC_PORT),
                            "inspectit-eum-server.exporters.tracing.service-name=" + SERVICE_NAME,
                            "inspectit-eum-server.exporters.tracing.otlp.protocol=" + TransportProtocol.GRPC.getConfigRepresentation())
                    .applyTo(applicationContext);
        }
    }
    @Test
    void verifyTraceSent() throws Exception {
    ...
    @Test
    void verifyTraceWithArrayValueSent() throws Exception {
        postResourceSpans();
